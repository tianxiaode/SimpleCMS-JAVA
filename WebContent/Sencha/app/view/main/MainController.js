Ext.define('SimpleCMS.view.main.MainController', {
    ...
    onMainViewRender: function () {
        var me = this;
        Ext.Msg.wait(AppLocale.GetUserInfo);
        Ext.Ajax.request({
            url: AppUrl.get('account', 'userinfo'),
            success: function (response, opts) {
                ...
                AppCfg.setUserInfo(obj.data.UserInfo);
                root.appendChild(obj.data.Menu);
                Ext.Msg.wait(AppLocale.StateRestoreWait);
                AppState.restore();
                Ext.Msg.hide();
                me.isLogin = true;
